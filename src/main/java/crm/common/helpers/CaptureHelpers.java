...
public class CaptureHelpers extends ScreenRecorder {
    ...
    public static void captureScreenshot(WebDriver driver, String screenName) {
        ...
        try {
            ...
            FileHandler.copy(source, new File(projectPath + PropertiesHelper.getValue("exportCapturePath") + "/" + screenName + "_" + dateFormat.format(new Date()) + ".png"));
    ...
    public static void startRecord(String methodName) throws Exception {
        ...
        File file = new File(projectPath + PropertiesHelper.getValue("exportVideoPath") + "/" + methodName + "/");
